...
function Write-Theme {
    ...
    If ($lastCommandFailed) {
        Write-Prompt -Object "x " -ForegroundColor $sl.Colors.CommandFailedIconForegroundColor
    }

    #check for elevated prompt
    If (([Security.Principal.WindowsPrincipal] [Security.Principal.WindowsIdentity]::GetCurrent()).IsInRole([Security.Principal.WindowsBuiltInRole] 'Administrator')) {
        Write-Prompt -Object "S " -ForegroundColor $sl.Colors.AdminIconForegroundColor
    }
    ...
    if ($status) {
        ...
        Write-Prompt -Object "$($status.branch) " -ForegroundColor $themeInfo.BackgroundColor 
    }    
    ...
    Write-Prompt -Object $sl.PromptSymbols.PromptIndicator -ForegroundColor $sl.Colors.DriveForegroundColor
}
